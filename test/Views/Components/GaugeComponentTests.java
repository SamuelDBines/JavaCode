 ...
 * @author ASUS-X55L
 */
public class GaugeComponentTests 
{
    public GaugeComponentTests() {
    ...
    public void AutomaticComponentTest() {
         ViewComponentGauge views = new AutomaticClockComponent(0, 10, "test", "test");
         ComponentTest1(views);
         ComponentTest2(views);
         ComponentTest3(views);
    } 
